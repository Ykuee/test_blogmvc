        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${userList}" var="userEntity">
                <tr>
                    ...
                    <td>
                        <a href="/admin/users/show/${userEntity.id}" type="button" class="btn btn-sm btn-success">详情</a>
                        <a href="/admin/users/update/${userEntity.id}" type="button" class="btn btn-sm btn-warning">修改</a>
                        <a href="/admin/users/delete/${userEntity.id}" type="button" class="btn btn-sm btn-danger">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
